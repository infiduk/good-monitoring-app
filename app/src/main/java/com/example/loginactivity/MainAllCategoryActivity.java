...
public class MainAllCategoryActivity extends AppCompatActivity {
    String userID;
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            target = "http://euniceparkjob.cafe24.com/projectList.php";
        }
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(MainAllCategoryActivity.this, ManagementAllCategoryActivity.class);
...
//            }
            MainAllCategoryActivity.this.startActivity(intent);//ManagementRecentlyActivity로 넘어감
            finish();
        }
    }
}
