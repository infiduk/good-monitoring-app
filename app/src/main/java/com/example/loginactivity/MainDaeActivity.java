...
public class MainDaeActivity extends AppCompatActivity {
    String userID;
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            target = "http://euniceparkjob.cafe24.com/projectListDae.php";
        }
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(MainDaeActivity.this, ManagementDaeActivity.class);
...
//            }
            MainDaeActivity.this.startActivity(intent);//ManagementRecentlyActivity로 넘어감
            finish();
        }
    }
}
