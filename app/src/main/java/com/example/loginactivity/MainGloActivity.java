...
public class MainGloActivity extends AppCompatActivity {
    String userID;
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            target = "http://euniceparkjob.cafe24.com/projectListGlo.php";
        }
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(MainGloActivity.this, ManagementGloActivity.class);
...
//            }
            MainGloActivity.this.startActivity(intent);//ManagementRecentlyActivity로 넘어감
            finish();
        }
    }
}
