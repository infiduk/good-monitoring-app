...
public class MainRecentlyActivity extends AppCompatActivity {
    String userID;
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(MainRecentlyActivity.this, ManagementRecentlyActivity.class);
...
//            }
            MainRecentlyActivity.this.startActivity(intent);//ManagementRecentlyActivity로 넘어감
            finish();
        }
    }
}
