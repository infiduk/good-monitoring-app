...
public class MainRecentlyActivity2 extends AppCompatActivity {
    String userID;
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(MainRecentlyActivity2.this, ManagementRecentlyActivity2.class);
...
//            }
            MainRecentlyActivity2.this.startActivity(intent);//ManagementRecentlyActivity로 넘어감
            finish();
        }
    }
}
