...
public class MainRecentlyActivity3 extends AppCompatActivity {
    String userID;
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(MainRecentlyActivity3.this, ManagementRecentlyActivity3.class);
...
//            }
            MainRecentlyActivity3.this.startActivity(intent);//ManagementRecentlyActivity로 넘어감
            finish();
        }
    }
}
