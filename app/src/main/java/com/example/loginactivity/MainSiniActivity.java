...
public class MainSiniActivity extends AppCompatActivity {
    String userID;
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            target = "http://euniceparkjob.cafe24.com/projectListSini.php";
        }
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(MainSiniActivity.this, ManagementSiniActivity.class);
...
//            }
            MainSiniActivity.this.startActivity(intent);//ManagementRecentlyActivity로 넘어감
            finish();
        }
    }
}
