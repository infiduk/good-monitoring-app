...
public class ManagementActivity extends AppCompatActivity {
    ...
    private Button button, button2, allCategoryButton;
    private DrawerLayout mDrawerLayout;
    private String isAdmin;
    private ImageView userImage;
    private TextView userIdInfo, userMessage;
    private NavigationView navigationView;
    private ImageButton imagebuttonLinear1, imagebuttonLinear2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = findViewById(R.id.loginActivityGo);
        button2 = findViewById(R.id.addActivityGo);
        allCategoryButton = findViewById(R.id.allCategoryButton);
        listView = (ListView)findViewById(R.id.listView);
        listView1 = findViewById(R.id.listView1);
        imagebuttonLinear1 = findViewById(R.id.imagebuttonLinear1);
        imagebuttonLinear2 = findViewById(R.id.imagebuttonLinear2);
        ...
        if (id != null) {
            if (id.equals("admin")) {
                Log.d("어드민계정이다이말이야", isAdmin + "임");
                button2.setVisibility(View.VISIBLE);
                Toast.makeText(getApplicationContext(), id + " 님으로 접속 중입니다.", Toast.LENGTH_SHORT).show();
        ...
        /*if(intent.getExtras().getString("isAdmin") != null) {
            isAdmin = intent.getExtras().getString("isAdmin");
            Log.d("로그인정보가있다이말이야", isAdmin);

            if(isAdmin.equals("admin")) {
                Log.d("어드민계정이다이말이야", isAdmin + "임");
                button2.setVisibility(View.VISIBLE);
                Toast.makeText(getApplicationContext(), isAdmin + " 님 환영합니다.", Toast.LENGTH_SHORT).show();
                Log.d("앱데이터에도정보가있냐이말이야","앱데이터에는아이디가" + id + "비밀번호가" + pwd);
                userImage.setImageResource(R.drawable.admin);
                userIdInfo.setText("관리자님");
                userMessage.setText("현재 접속중 입니다.");
            }
            else {
                Log.d("일반계정이다이말이야", isAdmin + "임");
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success)
                            {
                                ...
                                Intent intent = new Intent(ManagementActivity.this, UserProjectDetail.class);
        ...
        if(isAdmin != null || id != null) {
            Log.d("로그아웃할거다이말이야",id + "혹은" + isAdmin + "이로그아웃할것임");
            button.setOnClickListener(new Button.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder idpwBuilder = new AlertDialog.Builder(ManagementActivity.this);
                    idpwBuilder.setMessage("로그아웃하시겠습니까? 자동으로 앱이 종료됩니다.")
                            .setPositiveButton("네", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    // 확인시 처리 로직
                                    delete();
                                    ActivityCompat.finishAffinity(ManagementActivity.this);
                                }})
            ...
            Log.d("로그인할거다이말이야","그래그래");
            button.setOnClickListener(new Button.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(ManagementActivity.this, LoginActivity2.class);
                    ManagementActivity.this.startActivity(intent);
                }
            });
        }

        allCategoryButton.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ManagementActivity.this, MainAllCategoryActivity.class);
                ManagementActivity.this.startActivity(intent);
            }
        });

        imagebuttonLinear1.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ManagementActivity.this, MainRecentlyActivity2.class);
                ManagementActivity.this.startActivity(intent);
            }
        });

        imagebuttonLinear2.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ManagementActivity.this, MainRecentlyActivity2.class);
                ManagementActivity.this.startActivity(intent);
        ...
        button2.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ManagementActivity.this, ProjectAddActivity.class);
                ManagementActivity.this.startActivity(intent);
            }
        });
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id1) {
                    case R.id.gotoMain:
                        Intent intent1 = new Intent(ManagementActivity.this, MainActivity.class);
                        ManagementActivity.this.startActivity(intent1);
                        finish();
                        break;

                    case R.id.recently:
                        Intent intent2 = new Intent(ManagementActivity.this, MainRecentlyActivity.class);
                        ManagementActivity.this.startActivity(intent2);
                        finish();
                        break;

                    case R.id.allCategory:
                        Intent intent3 = new Intent(ManagementActivity.this, MainAllCategoryActivity.class);
                        ManagementActivity.this.startActivity(intent3);
                        finish();
                        break;

                    case R.id.studentCategory:
                        Intent intent4 = new Intent(ManagementActivity.this, MainDaeActivity.class);
                        ManagementActivity.this.startActivity(intent4);
                        finish();
                        break;

                    case R.id.womanCategory:
                        Intent intent5 = new Intent(ManagementActivity.this, MainJuActivity.class);
                        ManagementActivity.this.startActivity(intent5);
                        finish();
                        break;

                    case R.id.normalCategory:
                        Intent intent6 = new Intent(ManagementActivity.this, MainIllActivity.class);
                        ManagementActivity.this.startActivity(intent6);
                        finish();
                        break;

                    case R.id.globalCategory:
                        Intent intent7 = new Intent(ManagementActivity.this, MainGloActivity.class);
                        ManagementActivity.this.startActivity(intent7);
                        finish();
                        break;

                    case R.id.grandCategory:
                        Intent intent8 = new Intent(ManagementActivity.this, MainSiniActivity.class);
                    ...
                    case R.id.useInfoResume:
                        if(id.equals("admin")) {
                            Intent intent9 = new Intent(ManagementActivity.this, MainRecentlyActivity3.class);
