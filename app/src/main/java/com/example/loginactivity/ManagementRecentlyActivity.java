...
public class ManagementRecentlyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success)
                            {
                                ...
                                Intent intent = new Intent(ManagementRecentlyActivity.this, UserProjectDetail.class);
                                ...
                                ManagementRecentlyActivity.this.startActivity(intent);
                            }
                            else {
                                AlertDialog.Builder builder = new AlertDialog.Builder(ManagementRecentlyActivity.this);
                ...
                RequestQueue queue = Volley.newRequestQueue(ManagementRecentlyActivity.this);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id1) {
                    case R.id.gotoMain:
                        Intent intent1 = new Intent(ManagementRecentlyActivity.this, MainActivity.class);
                        ManagementRecentlyActivity.this.startActivity(intent1);
                        finish();
                        break;

                    case R.id.recently:
                        Intent intent2 = new Intent(ManagementRecentlyActivity.this, MainRecentlyActivity.class);
                        ManagementRecentlyActivity.this.startActivity(intent2);
                        finish();
                        break;

                    case R.id.allCategory:
                        Intent intent3 = new Intent(ManagementRecentlyActivity.this, MainAllCategoryActivity.class);
                        ManagementRecentlyActivity.this.startActivity(intent3);
                        finish();
                        break;

                    case R.id.studentCategory:
                        Intent intent4 = new Intent(ManagementRecentlyActivity.this, MainDaeActivity.class);
                        ManagementRecentlyActivity.this.startActivity(intent4);
                        finish();
                        break;

                    case R.id.womanCategory:
                        Intent intent5 = new Intent(ManagementRecentlyActivity.this, MainJuActivity.class);
                        ManagementRecentlyActivity.this.startActivity(intent5);
                        finish();
                        break;

                    case R.id.normalCategory:
                        Intent intent6 = new Intent(ManagementRecentlyActivity.this, MainIllActivity.class);
                        ManagementRecentlyActivity.this.startActivity(intent6);
                        finish();
                        break;

                    case R.id.globalCategory:
                        Intent intent7 = new Intent(ManagementRecentlyActivity.this, MainGloActivity.class);
                        ManagementRecentlyActivity.this.startActivity(intent7);
                        finish();
                        break;

                    case R.id.grandCategory:
                        Intent intent8 = new Intent(ManagementRecentlyActivity.this, MainSiniActivity.class);
                        ManagementRecentlyActivity.this.startActivity(intent8);
                        finish();
                        break;

                    case R.id.useInfoResume:
                        if(id.equals("admin")) {
                            Intent intent9 = new Intent(ManagementRecentlyActivity.this, MainRecentlyActivity3.class);
                            ManagementRecentlyActivity.this.startActivity(intent9);
                            finish();
                        }
                        break;
